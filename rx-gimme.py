...
class Window:
    def __init__(self, root):
        ...
        self.label_url.grid(
            row=self.first_row, column=self.first_column, sticky="w", padx=4, pady=4
        )
        ...
        self.button_save = Button(
            frame, text="Save buffer...", width=10, command=self.file_save_as
        )
        ...
        self.scrollbar.grid(
            row=self.first_row + 1, column=self.first_column + 4, sticky="NS"
        )
